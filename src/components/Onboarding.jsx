...
export default function Onboarding({ onComplete }) {
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 300, color: 'var(--text-primary)', marginBottom: '0.75rem' }}>
          What draws your eye?
        </h1>
        <p style={{ fontFamily: 'var(--sans)', color: 'var(--text-secondary)', fontSize: '0.95rem', letterSpacing: '0.05em' }}>
        ...
        {CARDS.map((card, i) => {
          ...
          return (
            <motion.button
              ...
              onHoverStart={() => setHovering(card.id)}
            ...
            >
              ...
              <span style={{
                fontFamily: 'var(--serif)', fontSize: '0.95rem', fontWeight: 400,
                color: isSelected ? '#fff' : 'var(--text-primary)',
                lineHeight: 1.2
              }}>{card.label}</span>
              <span style={{
                fontFamily: 'var(--sans)', fontSize: '0.72rem', letterSpacing: '0.04em',
